    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.appointments.update", [$appointment->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control datetime {{ $errors->has('date') ? 'is-invalid' : '' }}" type="text" name="date" id="date" value="{{ old('date', $appointment->date) }}">
                @if($errors->has('date'))
                    <div class="invalid-feedback">
                        {{ $errors->first('date') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('insurance') ? 'is-invalid' : '' }}" type="text" name="insurance" id="insurance" value="{{ old('insurance', $appointment->insurance) }}">
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('agree') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="agree" id="agree" value="1" {{ $appointment->agree || old('agree', 0) === 1 ? 'checked' : '' }}>
