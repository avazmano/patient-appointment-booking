            ...
            <table class=" table table-bordered table-striped table-hover datatable datatable-Appointment">
                <thead>
                    <tr>
                        ...
                        <th>
                            {{ trans('cruds.appointment.fields.insurance') }}
                        </th>
                        <th>
                            {{ trans('cruds.appointment.fields.agree') }}
                        </th>
                        <th>
                            &nbsp;
                        </th>
                ...
                <tbody>
                    @foreach($appointments as $key => $appointment)
                        <tr data-entry-id="{{ $appointment->id }}">
                            ...
                            <td>
                                <span style="display:none">{{ $appointment->agree ?? '' }}</span>
                                <input type="checkbox" disabled="disabled" {{ $appointment->agree ? 'checked' : '' }}>
                            </td>
                            <td>
